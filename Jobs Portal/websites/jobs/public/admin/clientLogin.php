...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $statement = $Connection->prepare('SELECT * FROM clients WHERE username = :username');
    ...
    // Authentication successful
        ...
        $_SESSION['client_id'] = $client['client_id']; // Set the user_id in the session
        $_SESSION['username'] = $username; // Set the username in the session
        $_SESSION['role'] = 'client'; // Set the role of the user in the session
...
<head>
  ...
  <title>Jo's Jobs - Client Login</title>
  <style>
    body {
